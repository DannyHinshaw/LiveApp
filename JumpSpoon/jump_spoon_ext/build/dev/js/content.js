...
var airTableXHREvent = new CustomEvent('AirTableXHR::finished');
...
window.addEventListener('load', function (event) {
  var form = {
    ...
    generateIframes: function generateIframes(container) {
      ...
      [].concat(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_toConsumableArray___default()(document.querySelectorAll('.detailViewTextWithLinks a'))).forEach(function (link, i) {
        if (i === 3) {
  ...
  window.addEventListener('AirTableXHR::finished', function () {
    ...
    var formFactoryFn = function formFactoryFn() {
      return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_create___default()(form);
    };
    var formify = formFactoryFn();
