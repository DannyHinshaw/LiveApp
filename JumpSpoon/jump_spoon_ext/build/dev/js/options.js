...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(74);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__msg__ = __webpack_require__(54);
...
function callback(res) {
  log('<<<<< callback invoked, return value = ' + __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(res));
}

var runner = {};

runner.go = function (msg, info) {
  if ('bg' === info.type) {
    // msg.bg
    if ('echo' === info.cmd) {
    ...
    if (-1 === info.tab) {
      ...
      if (info.ctx_all) {
        ...
        log('>>>>> invoking msg.' + info.type + '(' + __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(info.ctxs) + ', \'echo\', \'' + info.arg + '\', callback)');
      ...
      if (info.ctx_all) {
        ...
        msg[info.type](__WEBPACK_IMPORTED_MODULE_1__msg__["a" /* default */].SAME_TAB, 'echo', info.arg, callback);
      } else {
        log('>>>>> invoking msg.' + info.type + '(SAME_TAB, ' + __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(info.ctxs) + ', \'echo\', \'' + info.arg + '\', callback)');
        msg[info.type](__WEBPACK_IMPORTED_MODULE_1__msg__["a" /* default */].SAME_TAB, info.ctxs, 'echo', info.arg, callback);
      }
    } else if (info.ctx_all) {
      // tab id provided
      log('>>>>> invoking msg.' + info.type + '(' + info.tab + ', \'echo\', \'' + info.arg + '\', callback)');
      msg[info.type](info.tab, 'echo', info.arg, callback);
    } else {
      log('>>>>> invoking msg.' + info.type + '(' + info.tab + ', ' + __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(info.ctxs) + ', \'echo\', \'' + info.arg + '\', callback)');
      msg[info.type](info.tab, info.ctxs, 'echo', info.arg, callback);
    }
  } else if (-1 === info.tab) {
    // all tab ids // random + randomAsync
    if (info.ctx_all) {
      log('>>>>> invoking msg.' + info.type + '(\'' + info.cmd + '\', callback)');
      msg[info.type](info.cmd, callback);
    } else {
      log('>>>>> invoking msg.' + info.type + '(' + __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(info.ctxs) + ', \'' + info.cmd + '\', callback)');
    ...
    if (info.ctx_all) {
      ...
      msg[info.type](__WEBPACK_IMPORTED_MODULE_1__msg__["a" /* default */].SAME_TAB, info.cmd, callback);
    } else {
      log('>>>>> invoking msg.' + info.type + '(SAME_TAB, ' + __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(info.ctxs) + ', \'' + info.cmd + '\', callback)');
      msg[info.type](__WEBPACK_IMPORTED_MODULE_1__msg__["a" /* default */].SAME_TAB, info.ctxs, info.cmd, callback);
    }
  } else if (info.ctx_all) {
    // tab id provided
    ...
    log('>>>>> invoking msg.' + info.type + '(' + info.tab + ', ' + __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(info.ctxs) + ', \'' + info.cmd + '\', callback)');
    msg[info.type](info.tab, info.ctxs, info.cmd, callback);
  }
};

// for surpressing console.log output in unit tests:
runner.__resetLog = function () {
  log = function log() {};
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_form__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_runner__ = __webpack_require__(75);
...
__WEBPACK_IMPORTED_MODULE_2__modules_form__["a" /* default */].init(__WEBPACK_IMPORTED_MODULE_3__modules_runner__["a" /* default */].go.bind(__WEBPACK_IMPORTED_MODULE_3__modules_runner__["a" /* default */], __WEBPACK_IMPORTED_MODULE_1__modules_msg__["a" /* default */].init('options', __WEBPACK_IMPORTED_MODULE_0__modules_handlers__["a" /* default */].create('options'))));
